...
RETURNS NAME[] AS $$
    SELECT return_arg_types FROM tap_funky WHERE schema = $1 AND name = $2
$$ LANGUAGE SQL;
...
RETURNS NAME[] AS $$
    SELECT return_arg_types FROM tap_funky WHERE name = $1 AND is_visible;
$$ LANGUAGE SQL;
...
RETURNS NAME[] AS $$
    SELECT return_arg_names FROM tap_funky WHERE schema = $1 AND name = $2
$$ LANGUAGE SQL;
...
RETURNS NAME[] AS $$
    SELECT return_arg_names FROM tap_funky WHERE name = $1 AND is_visible;
$$ LANGUAGE SQL;
